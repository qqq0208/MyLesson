...
public class ML {
    ...
    public interface Order {
        ...
        static String statusFormat(Integer statusCode) {
            if (Objects.equals(statusCode, UNPAID)) {
                return "未付款";
            }
            if (Objects.equals(statusCode, PAID)) {
                return "已付款";
            }
            if (Objects.equals(statusCode, CANCEL)) {
                return "已取消";
            }
            if (Objects.equals(statusCode, OTHER_STATE)) {
                return "其他";
            }
            return "异常";
        }
        ...
        static String payTypeFormat(Integer payTypeCode) {
            if (Objects.equals(payTypeCode, NO_PAY)) {
                return "未支付";
            }
            if (Objects.equals(payTypeCode, WECHAT_PAY)) {
                return "微信";
            }
            if (Objects.equals(payTypeCode, ALI_PAY)) {
                return "支付宝";
            }
            if (Objects.equals(payTypeCode, OTHER_PAY)) {
                return "其他";
            }
            return "异常";
        }
    ...
    public interface User {
        ...
        static String genderFormat(Integer genderCode) {
            if (Objects.equals(genderCode, FEMALE)) {
                return "女孩";
            }
            if (Objects.equals(genderCode, MALE)) {
                return "男孩";
            }
            if (Objects.equals(genderCode, SECRET)) {
                return "保密";
            }
            return "异常";
        }
    ...
    public interface Seckill {
        ...
        static String statusFormat(Integer seckillCode) {
            if (Objects.equals(seckillCode, NOT_START)) {
                return "未开始";
            }
            if (Objects.equals(seckillCode, STARTED)) {
                return "已开始";
            }
            if (Objects.equals(seckillCode, ENDED)) {
                return "已结束";
            }
            return "异常";
        }
