...
public class UserTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, USERNAME, PASSWORD, NICKNAME, AVATAR, PHONE, EMAIL, GENDER, AGE, ZODIAC, PROVINCE, REALNAME, IDCARD, INFO, VERSION, CREATED, UPDATED};
